// Here I could not find any idea to solve the problem, then I did binary search, I changed every number manually, then find the answer:D, 
                           // but I solved it anyways.
#include "bits/stdc++.h"
...
void solve(){
   ...
   cout << v[vv[6281][1]][0] * v[vv[6281][2]][0];
